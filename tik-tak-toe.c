...
void Game(void) {
    ...
    {   
        ...
        else if (IsMarkAble[1] == false && pos == 2) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
	    ...
	    else if (IsMarkAble[2] == false && pos == 3) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
	    ...
	    else if (IsMarkAble[3] == false && pos == 4) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
	    ...
	    else if (IsMarkAble[4] == false && pos == 5) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
        ...
        else if (IsMarkAble[5] == false && pos == 6) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
        ...
        else if (IsMarkAble[6] == false && pos == 7) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
        ...
        else if (IsMarkAble[7] == false && pos == 8) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
        ...
        else if (IsMarkAble[8] == false && pos == 9) {
            while(true) 
            {
            printf("Invalid move\n\n");
            printf("Player1 (X): ");
